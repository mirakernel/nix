  ...
  config = lib.mkIf config.my.hm.plasma.enable {
    ...
    programs.plasma = {
      ...
      shortcuts = {
        ...
        "KDE Keyboard Layout Switcher"."Switch keyboard layout to Английская (США)" = [ ];
        "KDE Keyboard Layout Switcher"."Switch keyboard layout to Русская" = [ ];
      ...
      configFile = {
        ...
        dolphinrc.General.ViewPropsTimestamp = "2026,2,11,23,49,37.797";
        dolphinrc.IconsMode.PreviewSize = 96;
        dolphinrc."KFileDialog Settings"."Places Icons Auto-resize" = false;
        dolphinrc."KFileDialog Settings"."Places Icons Static Size" = 22;
        kactivitymanagerdrc.activities."31e8453d-0843-49ee-8d79-fe3ca3aae883" = "Рабочая";
        kactivitymanagerdrc.activities."5ee31e54-3b02-48f6-bc4e-159760bc8e47" = "Личная";
        kactivitymanagerdrc.activities-descriptions."31e8453d-0843-49ee-8d79-fe3ca3aae883" = "Рабочая комната";
        kactivitymanagerdrc.activities-descriptions."5ee31e54-3b02-48f6-bc4e-159760bc8e47" = "Комната с личными вещами";
        kactivitymanagerdrc.activities-icons."31e8453d-0843-49ee-8d79-fe3ca3aae883" = "planwork";
        kactivitymanagerdrc.activities-icons."5ee31e54-3b02-48f6-bc4e-159760bc8e47" = "user-grace-hopper";
        kactivitymanagerdrc.main.currentActivity = "5ee31e54-3b02-48f6-bc4e-159760bc8e47";
        ...
        katerc.filetree.editShade = "83,32,106";
        ...
        kcminputrc."Libinput/1267/47/Elan Touchpad".NaturalScroll = true;
        ...
        kscreenlockerrc."Greeter/Wallpaper/org.kde.image/General".Image = "file://${wallpaper}";
        ksmserverrc.General.loginMode = "emptySession";
        kwalletrc.Wallet."First Use" = false;
        kwinrc.Desktops.Id_1 = "c1d5ce2c-24df-46d5-b604-63ab55920087";
        kwinrc.Desktops.Id_2 = "c9f97de0-3743-4c4a-9ceb-369b941eec9d";
        kwinrc.Desktops.Id_3 = "a86e2e5d-3e6e-4ad3-af29-1e6c1328b2ae";
        kwinrc.Desktops.Id_4 = "25ec1b11-6efb-4f79-8eb0-e02bab19f854";
        kwinrc.Desktops.Number = 4;
        kwinrc.Desktops.Rows = 1;
        kwinrc.Tiling.padding = 4;
        kwinrc."Tiling/25ec1b11-6efb-4f79-8eb0-e02bab19f854/51c0a60f-8074-4df2-bc75-e987261acc26".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
        kwinrc."Tiling/25ec1b11-6efb-4f79-8eb0-e02bab19f854/8c65400c-0763-46e0-90d6-aa9427752a55".padding = 4;
        kwinrc."Tiling/25ec1b11-6efb-4f79-8eb0-e02bab19f854/8c65400c-0763-46e0-90d6-aa9427752a55".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        kwinrc."Tiling/6a36ebeb-fd93-40da-9583-c315ca093384/8c65400c-0763-46e0-90d6-aa9427752a55".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        kwinrc."Tiling/a86e2e5d-3e6e-4ad3-af29-1e6c1328b2ae/51c0a60f-8074-4df2-bc75-e987261acc26".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
        kwinrc."Tiling/a86e2e5d-3e6e-4ad3-af29-1e6c1328b2ae/8c65400c-0763-46e0-90d6-aa9427752a55".padding = 4;
        kwinrc."Tiling/a86e2e5d-3e6e-4ad3-af29-1e6c1328b2ae/8c65400c-0763-46e0-90d6-aa9427752a55".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        kwinrc."Tiling/c1d5ce2c-24df-46d5-b604-63ab55920087/51c0a60f-8074-4df2-bc75-e987261acc26".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
        kwinrc."Tiling/c1d5ce2c-24df-46d5-b604-63ab55920087/8c65400c-0763-46e0-90d6-aa9427752a55".padding = 4;
        kwinrc."Tiling/c1d5ce2c-24df-46d5-b604-63ab55920087/8c65400c-0763-46e0-90d6-aa9427752a55".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        kwinrc."Tiling/c9f97de0-3743-4c4a-9ceb-369b941eec9d/51c0a60f-8074-4df2-bc75-e987261acc26".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":\x5b{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}\x5d}";
        kwinrc."Tiling/c9f97de0-3743-4c4a-9ceb-369b941eec9d/8c65400c-0763-46e0-90d6-aa9427752a55".padding = 4;
        kwinrc."Tiling/c9f97de0-3743-4c4a-9ceb-369b941eec9d/8c65400c-0763-46e0-90d6-aa9427752a55".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      dataFile = {
        "kate/anonymous.katesession"."Document 0".URL = "sftp://root@192.168.0.15:22/root/mnt/arch-bkp/.emacs.d/config.org";
        ...
        "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-0-Splitter = 687;
        ...
        "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-1-Splitter = 687;
        ...
        "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-2-Splitter = 1491;
        ...
        "kate/anonymous.katesession".MainWindow0.Kate-MDI-Sidebar-3-Splitter = 1141;
        ...
        "kate/anonymous.katesession".MainWindow0.Kate-MDI-V-Splitter = "0,687,0";
