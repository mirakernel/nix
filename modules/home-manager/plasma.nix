  ...
  config = lib.mkIf config.my.hm.plasma.enable {
    ...
    programs.plasma = {
      ...
      configFile = {
        ...
        kwinrc."Tiling/25ec1b11-6efb-4f79-8eb0-e02bab19f854/51c0a60f-8074-4df2-bc75-e987261acc26".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        kwinrc."Tiling/a86e2e5d-3e6e-4ad3-af29-1e6c1328b2ae/51c0a60f-8074-4df2-bc75-e987261acc26".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        kwinrc."Tiling/c1d5ce2c-24df-46d5-b604-63ab55920087/51c0a60f-8074-4df2-bc75-e987261acc26".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
        kwinrc."Tiling/c9f97de0-3743-4c4a-9ceb-369b941eec9d/51c0a60f-8074-4df2-bc75-e987261acc26".tiles = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
